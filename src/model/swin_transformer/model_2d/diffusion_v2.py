...
class SwinDiffusion(nn.Module):
    ...
    def forward(self, x, time, cond=None, x_self_cond=None, class_labels=None):
        ...
        for idx, (skip_conv_layer_1, skip_conv_layer_2,
            ...
            x = layer_1(x, time_emb=time_emb, cond_emb=skip_cond, class_emb=None)

            skip_x, skip_cond = skip_connect_list_2[idx]
            x = skip_conv_layer_2(x, skip_x)
            x = layer_2(x, time_emb=time_emb, cond_emb=skip_cond, class_emb=None)

            x = layer_3(x, time_emb=time_emb, class_emb=None)
