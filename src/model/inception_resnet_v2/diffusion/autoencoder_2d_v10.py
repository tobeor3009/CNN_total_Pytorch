...
class InceptionResNetV2_UNet(nn.Module):
    ...
    def get_encode_mixed_6a(self, emb_dim_list, emb_type_list):
        ...
        attn_layer = self.get_attn_layer(block_size * 68, self.num_head_list[layer_idx],
                                         self.attn_info_list[layer_idx])
    ...
    def get_encode_mixed_7a(self, emb_dim_list, emb_type_list):
        ...
        attn_layer = self.get_attn_layer(block_size * 130, self.num_head_list[layer_idx],
                                         self.attn_info_list[layer_idx])
