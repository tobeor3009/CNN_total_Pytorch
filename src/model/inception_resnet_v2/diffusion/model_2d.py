...
from .diffusion_layer import ConvBlock2D, Inception_Resnet_Block2D, MultiDecoder2D 
...
class InceptionResNetV2_UNet(nn.Module):
    def __init__(self, in_channel, cond_channel, out_channel, img_size, block_size=16, decode_init_channel=None,
        ...
        self.decode_final_conv = nn.Conv2d(decode_out_channel, out_channel, 1, bias=False)
        self.decode_final_act = get_act(last_act)
    ...
    def forward(self, x, time, cond=None, x_self_cond=None, class_labels=None):
        ...
        decode_feature = self.decode_final_act(decode_feature)
