...
def get_skip_connect_channel_list(block_size):
...
class InceptionResNetV2_2D(nn.Module):
    def __init__(self, n_input_channels, block_size=16,
        ...
        self.stem = nn.ModuleDict({
            ...
            'stem_layer_2': ConvBlock2D(block_size * 2, block_size * 2, 3, padding=padding_3x3),
            ...
            'stem_layer_6': ConvBlock2D(block_size * 5, block_size * 12, 3, padding=padding_3x3),
        ...
        mixed_6a_branch_0 = ConvBlock2D(
            block_size * 20, block_size * 24, 3, stride=2, padding=padding_3x3)
        ...
        mixed_7a_branch_2 = nn.Sequential(
            ...
            ConvBlock2D(block_size * 18, block_size *
                        20, 3, stride=2, padding=padding_3x3)
        )
...
class InceptionResNetV2_3D(nn.Module):
    def __init__(self, n_input_channels, block_size=16,
        ...
        # Stem block
        self.stem = nn.ModuleDict({
            'stem_layer_1': ConvBlock3D(n_input_channels, block_size * 2, 3, stride=z_stride, padding=padding_3x3),
            'stem_layer_2': ConvBlock3D(block_size * 2, block_size * 2, 3, padding=padding_3x3),
            'stem_layer_3': ConvBlock3D(block_size * 2, block_size * 4, 3),
            'stem_layer_4': nn.MaxPool3d(3, stride=z_stride, padding=padding_3x3),
            'stem_layer_5': ConvBlock3D(block_size * 4, block_size * 5, 1),
            'stem_layer_6': ConvBlock3D(block_size * 5, block_size * 12, 3, padding=padding_3x3),
