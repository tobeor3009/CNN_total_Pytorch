...
class ResNet2d(nn.Module):
    def __init__(
        ...
        self.conv1 = nn.Conv2d(in_channel, self.inplanes,
...
def _resnet(
    ...
    **kwargs: Any,
    ...
    model = ResNet2d(block, block_size, layers, in_channel, **kwargs)
...
def resnet(in_channel=3, block_size=64, block_depth_list=[1, 2, 3, 1],
           progress: bool = True, **kwargs: Any) -> ResNet2d:
    weights = None
    return _resnet(Bottleneck, block_size, block_depth_list, in_channel, weights, progress, **kwargs)


def resnet_tiny(in_channel=3, progress: bool = True, **kwargs: Any) -> ResNet2d:
    weights = None
    return _resnet(Bottleneck, 64, [1, 2, 3, 1], in_channel, weights, progress, **kwargs)


def resnet50(in_channel=3, progress: bool = True, **kwargs: Any) -> ResNet2d:
    weights = None
    return _resnet(Bottleneck, 64, [3, 4, 6, 3], in_channel, weights, progress, **kwargs)


def resnet101(in_channel=3, progress: bool = True, **kwargs: Any) -> ResNet2d:
    weights = None
