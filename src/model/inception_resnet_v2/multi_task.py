    ...
    def forward(self, input_tensor):
        ...
        for decode_i in range(0, 5):
            ...
            if self.skip_connect:
                skip_connect_tensor = getattr(
                    self.base_model, f"skip_connect_tensor_{4 - decode_i}")
        ...
        seg_output = self.output_conv(decoded)
...
class ClassificationHead(nn.Module):
    ...
    def forward(self, x):
        ...
        x = x.flatten(2).permute(2, 0, 1)  # flatten and transpose to [S, N, E]
